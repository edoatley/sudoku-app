...
- [ ] **UM-GCP-005**: On GCP the system shall apply the email allowlist identically to AWS, requiring the token's email claim to be on app.allowed.emails AND email_verified to be true, regardless of sign-in provider.
