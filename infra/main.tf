...
locals {
  ...
  cognito_web_client_id       = local.is_rc ? data.aws_cognito_user_pool_client.rc_web[0].id : aws_cognito_user_pool_client.web[0].id
  cognito_smoke_client_id     = local.is_rc ? data.aws_cognito_user_pool_client.rc_smoke[0].id : aws_cognito_user_pool_client.smoke_test[0].id
  cognito_smoke_client_secret = local.is_rc ? data.aws_cognito_user_pool_client.rc_smoke[0].client_secret : aws_cognito_user_pool_client.smoke_test[0].client_secret
}
