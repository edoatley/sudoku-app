...
class LeaderboardResourceTest {
    ...
    void getLeaderboard_returnsOkWithEntries() {
        when(leaderboardService.getLeaderboard()).thenReturn(
                new com.sudoku.leaderboard.web.LeaderboardResponse(List.of(rankOneEntry(), rankTwoEntry()))
        );
    ...
    void getLeaderboard_includesBestTimeByDifficulty() {
        when(leaderboardService.getLeaderboard()).thenReturn(
                new com.sudoku.leaderboard.web.LeaderboardResponse(List.of(rankOneEntry()))
        );
    ...
    void getLeaderboard_noPlayers_returnsEmptyEntries() {
        when(leaderboardService.getLeaderboard()).thenReturn(
                new com.sudoku.leaderboard.web.LeaderboardResponse(Collections.emptyList())
        );
