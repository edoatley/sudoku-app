...
## The Action
1. Scan a row, column, or block for three numbers that only appear in the same three cells.
2. Once found, **erase** all *other* candidates from those three cells.
3. You have successfully stripped away the decoys, revealing a standard Naked Triple!
