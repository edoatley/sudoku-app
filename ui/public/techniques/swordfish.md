...
## The Action
1. Find three rows where a specific candidate is limited to the exact same three columns. (Or vice versa: three columns limited to three rows).
2. If the pattern is locked by Rows, **erase** that candidate from all other cells in those three Columns.
3. If the pattern is locked by Columns, **erase** the candidate from the rest of the Rows.
