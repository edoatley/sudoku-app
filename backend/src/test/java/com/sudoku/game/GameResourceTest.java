...
class GameResourceTest {
    ...
    void getGame_afterCreate_returnsMatchingState() {
        ...
        GameState saved = new GameState(USER_ID, gameId, "medium", GRID, GRID, emptyCandidates(), 0, "IN_PROGRESS", 0);
    ...
    void patchGame_updatesTimeAndReturns200() {
        ...
        GameState initial = new GameState(USER_ID, gameId, "easy", GRID, GRID, emptyCandidates(), 0, "IN_PROGRESS", 0);
        GameState updated = new GameState(USER_ID, gameId, "easy", GRID, GRID, emptyCandidates(), 60, "IN_PROGRESS", 0);
    ...
    void patchGame_withIsComplete_setsStatusToSolved() {
        ...
        GameState initial = new GameState(USER_ID, gameId, "easy", GRID, GRID, emptyCandidates(), 0, "IN_PROGRESS", 0);
        GameState solved  = new GameState(USER_ID, gameId, "easy", GRID, GRID, emptyCandidates(), 300, "SOLVED", 0);
        when(gameRepository.findById(USER_ID, gameId))
                .thenReturn(Optional.of(initial))
    ...
    void getCurrentGame_whenInProgress_returns200WithGame() {
        ...
        GameState inProgress = new GameState(USER_ID, gameId, "medium", GRID, GRID, emptyCandidates(), 45, "IN_PROGRESS", 0);
