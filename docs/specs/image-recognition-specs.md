...
- [x] **IR-API-001**: The system shall expose POST /api/v1/puzzles/import accepting a JSON body with a base64-encoded image field, requiring JWT authentication.
- [x] **IR-API-002**: The system shall expose GET /api/v1/puzzles/import/warmup requiring no authentication and returning HTTP 200 without invoking the Bedrock model.
